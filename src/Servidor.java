            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        System.out.println("Input recebido: "+timestamp_recebido.toString());
...
//                        System.out.println("Recebi mensagem: " + message);
                        ...
                        if (clientAddress != null) {
                            ...
                            if (currentTime - lastSendTime >= SEND_RATE) {
                                ...
                                if (x != xAnterior.get() || y != yAnterior.get()) {
                                    ...
                                    System.out.println("Input enviado(MOVIMENTÇÃO)"+timestamp_enviado);
